...
//    private static String outputDir = "notes-system\\src\\main\\java";
    private static String outputDir = "out-file";
    private static String parentPackage = "com.notes.system";
    private static String entityPackage = "domain";
    ...
    private static String mapperXmlPackage = "mapper";

    private static String tableName = "notes_user";
