...
import com.notes.common.utils.JsonUtil;
...
import com.notes.common.utils.uuid.IdUtils;
...
public class TokenService
{
     ...
     * @return 用户信息
     */
    public FrontLoginUser getLoginUser(HttpServletRequest request)
    {
        // 获取请求携带的令牌
...
//                LoginUser user = redisCache.getCacheObject(userKey);
     ...
     * @return 令牌
     */
    public String createToken(NotesUser noteUser)
    {
...
//        refreshToken(loginUser);
    ...
    private String createToken(Map<String, Object> claims)
    {
        String token = Jwts.builder()
            .setClaims(claims)
            .setExpiration(DateUtils.addMonths(new Date(), expireTime))
